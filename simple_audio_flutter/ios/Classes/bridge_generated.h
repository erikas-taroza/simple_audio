...
static int64_t dummy_method_to_enforce_bundling(void) {
    ...
    dummy_var ^= ((int64_t) (void*) wire_playback_state__method__Player);
    dummy_var ^= ((int64_t) (void*) wire_progress__method__Player);
    dummy_var ^= ((int64_t) (void*) wire_is_preloaded__method__Player);
    dummy_var ^= ((int64_t) (void*) wire_is_looping__method__Player);
    dummy_var ^= ((int64_t) (void*) wire_is_normalizing__method__Player);
    dummy_var ^= ((int64_t) (void*) wire_volume__method__Player);
