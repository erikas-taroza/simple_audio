...
var arg2 = _platform.api2wire_opt_box_autoadd_i64(hwnd);
            ...
            callFfi: (port_) => _platform.inner.wire_new__static_method__Player(port_, arg0, arg1, arg2),
...
Stream<Callback> callbackStreamStaticMethodPlayer({ dynamic hint }) {
            ...
            return _platform.executeStream(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_callback_stream__static_method__Player(port_),
        ...
        FlutterRustBridgeTaskConstMeta get kCallbackStreamStaticMethodPlayerConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<bool> isPlayingMethodPlayer({ required Player that ,dynamic hint }) {
            ...
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_is_playing__method__Player(port_, arg0),
        ...
        FlutterRustBridgeTaskConstMeta get kIsPlayingMethodPlayerConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<bool> hasPreloadedMethodPlayer({ required Player that ,dynamic hint }) {
            var arg0 = _platform.api2wire_box_autoadd_player(that);
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_has_preloaded__method__Player(port_, arg0),
            parseSuccessData: _wire2api_bool,
            parseErrorData: null,
        ...
        FlutterRustBridgeTaskConstMeta get kHasPreloadedMethodPlayerConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<ProgressState> getProgressMethodPlayer({ required Player that ,dynamic hint }) {
            var arg0 = _platform.api2wire_box_autoadd_player(that);
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_get_progress__method__Player(port_, arg0),
            parseSuccessData: _wire2api_progress_state,
            parseErrorData: null,
        ...
        FlutterRustBridgeTaskConstMeta get kGetProgressMethodPlayerConstMeta => const FlutterRustBridgeTaskConstMeta(
...
var arg1 = _platform.api2wire_box_autoadd_metadata(metadata);
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_set_metadata__method__Player(port_, arg0, arg1),
            parseSuccessData: _wire2api_unit,
            parseErrorData: null,
        ...
        FlutterRustBridgeTaskConstMeta get kSetMetadataMethodPlayerConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Callback _wire2api_callback(dynamic raw) {
            switch (raw[0]) {
                case 0: return Callback_Error(_wire2api_box_autoadd_error(raw[1]),);
case 1: return Callback_MediaControlSkipPrev();
case 2: return Callback_MediaControlSkipNext();
case 3: return Callback_PlaybackLooped();
case 4: return Callback_DurationCalculated();
...
Error _wire2api_error(dynamic raw) {
            switch (raw[0]) {
                case 0: return Error_NetworkStream(message: _wire2api_String(raw[1]),);
case 1: return Error_Decode(message: _wire2api_String(raw[1]),);
case 2: return Error_Open(message: _wire2api_String(raw[1]),);
case 3: return Error_Preload(message: _wire2api_String(raw[1]),);
                default: throw Exception("unreachable");
            }
        }
...
ProgressState _wire2api_progress_state(dynamic raw) {
            final arr = raw as List<dynamic>;
                ...
                return ProgressState(position: _wire2api_u64(arr[0]),
...
@protected
                    ffi.Pointer<wire_list_media_control_action> api2wire_list_media_control_action(List<MediaControlAction> raw) {
...
late final OpaqueTypeFinalizer _ControlsFinalizer = OpaqueTypeFinalizer(inner._drop_opaque_ControlsPtr);
