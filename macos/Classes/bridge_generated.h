...
void wire_has_queue__method__Player(int64_t port_, struct wire_Player *that);
...
void wire_queue__method__Player(int64_t port_,
                                struct wire_Player *that,
                                struct wire_uint_8_list *path);

void wire_play_queue__method__Player(int64_t port_, struct wire_Player *that);
...
static int64_t dummy_method_to_enforce_bundling(void) {
    ...
    dummy_var ^= ((int64_t) (void*) wire_has_queue__method__Player);
    dummy_var ^= ((int64_t) (void*) wire_get_progress__method__Player);
    dummy_var ^= ((int64_t) (void*) wire_open__method__Player);
    dummy_var ^= ((int64_t) (void*) wire_queue__method__Player);
    dummy_var ^= ((int64_t) (void*) wire_play_queue__method__Player);
